...
async function run(){
    ...
    let sql = 'SELECT COALESCE(inventory_log.Matnr, models_information.Matnr) as Matnr FROM models_information LEFT JOIN inventory_log ON models_information.Matnr = inventory_log.Matnr WHERE inventory_log.Matnr IS NULL';
